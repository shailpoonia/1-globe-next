    ...
    <section id="philosophy" className="bg-background py-16 md:py-24">
      <div className="max-w-content mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16 md:mb-24">
          ...
          <h2 className="font-heading font-bold text-3xl sm:text-4xl md:text-5xl tracking-tighter leading-[0.95] text-foreground uppercase">
            BUSINESS FIRST.<br />
            TECHNOLOGY SECOND.<br />
            <span className="text-primary">PERFORMANCE ALWAYS.</span>
          </h2>
          <div className="mt-12 w-px h-16 bg-gradient-to-b from-neutral-800 to-transparent mx-auto" />
        </div>

        {/* The Three Principles - Pure Typography */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 lg:gap-16 border-t border-neutral-800 pt-12">
          
          <div className="flex flex-col">
            <span className="text-[10px] font-bold uppercase tracking-widest text-primary mb-5 block">01</span>
            <h3 className="font-heading font-bold text-xl lg:text-2xl tracking-tight text-foreground uppercase mb-4 leading-tight">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-bold uppercase tracking-widest text-primary mb-5 block">02</span>
            <h3 className="font-heading font-bold text-xl lg:text-2xl tracking-tight text-foreground uppercase mb-4 leading-tight">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] font-bold uppercase tracking-widest text-primary mb-5 block">03</span>
            <h3 className="font-heading font-bold text-xl lg:text-2xl tracking-tight text-foreground uppercase mb-4 leading-tight">
