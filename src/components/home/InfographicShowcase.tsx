    ...
    <section className="w-full section-spacing bg-background border-t border-border/50 overflow-hidden relative">
      ...
      <div className="max-w-content mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          {/* Carousel Container */}
          <div className="relative w-full rounded-none bg-secondary/30 border border-border overflow-hidden min-h-[500px]">
            {/* Nav Arrows */}
            <button 
              onClick={() => setActiveSlide(prev => prev === 0 ? 1 : 0)}
              className="absolute left-4 top-1/2 -tranneutral-y-1/2 z-20 w-10 h-10 rounded-full bg-neutral-800/80 border border-neutral-700 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-neutral-700 transition-colors"
            >
              <ChevronLeft className="w-5 h-5" />
            </button>
            <button 
              onClick={() => setActiveSlide(prev => prev === 0 ? 1 : 0)}
              className="absolute right-4 top-1/2 -tranneutral-y-1/2 z-20 w-10 h-10 rounded-full bg-neutral-800/80 border border-neutral-700 flex items-center justify-center text-neutral-400 hover:text-white hover:bg-neutral-700 transition-colors"
            >
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center">
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 w-full max-w-3xl mx-auto">
        ...
        {/* Visual Box */}
        <div className="relative w-full md:w-1/2 bg-neutral-800 border border-neutral-700/50 rounded-none overflow-hidden aspect-video shadow-none">
          ...
          <div className="absolute left-0 w-full h-[2px] bg-primary shadow-[0_0_8px_2px_rgba(0,213,255,0.6)] s1-animate-scan z-10">
            <div className="absolute top-0 left-0 w-full h-12 bg-gradient-to-b from-primary/20 to-transparent -tranneutral-y-full" />
          </div>
          <div className="absolute bottom-2 right-2 bg-neutral-900/80 backdrop-blur-md border border-neutral-700/50 rounded-none px-2.5 py-1.5 flex flex-col shadow-lg">
            <span className="text-[8px] font-bold text-neutral-500 uppercase tracking-widest mb-0.5">Example</span>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-medium text-neutral-400 line-through">8.2 MB</span>
              <span className="text-[11px] font-bold text-primary flex items-center gap-1">
                <Zap className="w-3 h-3 fill-current" /> 240 KB
              </span>
            </div>
          </div>
          <div className="absolute top-2 left-2 bg-neutral-900/70 backdrop-blur border border-neutral-700/50 rounded-none px-2 py-0.5 flex items-center gap-1.5">
            <Sparkles className="w-3 h-3 text-primary" />
            <span className="text-[10px] font-medium text-neutral-200 uppercase tracking-wider">AI Vision</span>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-4">
          <div className="space-y-1.5">
            ...
            <div className="border border-neutral-800 bg-neutral-900/60 rounded-none px-3 py-2 text-xs font-mono tracking-tight flex items-center overflow-hidden">
          ...
          <div className="space-y-1.5">
            ...
            <div className="border border-neutral-800 bg-neutral-900/60 rounded-none px-3 py-2 text-[12px] text-neutral-300 min-h-[50px] flex items-center">
          ...
          <div className="mt-2">
            <div className="text-[10px] font-bold uppercase tracking-wider text-neutral-500 mb-2">Image Context</div>
            <div className="flex flex-wrap gap-2">
              <div className="px-2 py-1 rounded-full border border-neutral-700/50 text-[10px] font-medium text-neutral-500 flex items-center gap-1 s1-animate-badge">
      ...
      <div className="mt-10 text-center px-4 md:px-12">
        ...
        <p className="text-sm text-neutral-400">Sound familiar? Half your catalog is probably named IMG-2026-WA001.jpg right now.</p>
      </div>
    </div>
  )
}
      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full flex flex-row items-center justify-between gap-1 md:gap-3 mb-10 overflow-x-auto pb-4 md:pb-0 hide-scrollbar">
          ...
          <div className="flex flex-col items-center gap-2 min-w-[70px]">
            <div className="w-12 h-12 rounded-full border-2 border-neutral-700 bg-neutral-800/50 text-neutral-500 flex items-center justify-center s2-node-1 relative shrink-0">
              <ImageIcon className="w-5 h-5" />
              <CheckCircle2 className="w-4 h-4 text-primary absolute -bottom-1 -right-1 bg-neutral-900 rounded-full" />
            </div>
            <span className="text-[10px] font-bold text-neutral-400 text-center leading-tight">Optimized<br/>Product</span>
          </div>

          <ArrowRight className="w-5 h-5 text-neutral-700 shrink-0 s2-arrow-1" />

          <div className="flex flex-col items-center gap-2 min-w-[70px]">
            <div className="w-12 h-12 rounded-full border-2 border-neutral-700 bg-neutral-800/50 text-neutral-500 flex items-center justify-center s2-node-2 shrink-0">
              <PenTool className="w-5 h-5" />
            </div>
            <span className="text-[10px] font-bold text-neutral-400 text-center leading-tight">1-BLOG<br/>Drafts Post</span>
          </div>

          <ArrowRight className="w-5 h-5 text-neutral-700 shrink-0 s2-arrow-2" />

          <div className="flex flex-col items-center gap-2 min-w-[70px]">
            <div className="w-12 h-12 rounded-full border-2 border-neutral-700 bg-neutral-800/50 text-neutral-500 flex items-center justify-center s2-node-3 shrink-0">
              <TrendingUp className="w-5 h-5" />
            </div>
            <span className="text-[10px] font-bold text-neutral-400 text-center leading-tight">Discovery &<br/>Context</span>
          </div>

          <ArrowRight className="w-5 h-5 text-neutral-700 shrink-0 s2-arrow-3" />

          <div className="flex flex-col items-center gap-2 min-w-[70px]">
            <div className="w-12 h-12 rounded-full border-2 border-neutral-700 bg-neutral-800/50 text-neutral-500 flex items-center justify-center s2-node-4 shrink-0">
              <MousePointerClick className="w-5 h-5" />
            </div>
            <span className="text-[10px] font-bold text-neutral-400 text-center leading-tight">Readers<br/>Click</span>
          </div>

          <ArrowRight className="w-5 h-5 text-neutral-700 shrink-0 s2-arrow-4" />

          <div className="flex flex-col items-center gap-2 min-w-[70px]">
            <div className="w-12 h-12 rounded-full border-2 border-neutral-700 bg-neutral-800/50 text-neutral-500 flex items-center justify-center s2-node-5 shrink-0">
              <ShoppingBag className="w-5 h-5" />
            </div>
            <span className="text-[10px] font-bold text-neutral-400 text-center leading-tight">Store Visit</span>
          </div>

        </div>

        {/* Mock Blog Card */}
        <div className="w-full max-w-md bg-neutral-800/80 border border-neutral-700 rounded-none overflow-hidden shadow-none mb-8 group flex items-start p-4 gap-4">
           <div className="relative w-20 h-20 rounded-none bg-neutral-700 overflow-hidden shrink-0">
           ...
           <div>
             ...
             <h4 className="text-sm font-semibold text-neutral-200 leading-tight mb-2">The Art of Sanganer Hand Block Printing — A Bedroom Story</h4>
