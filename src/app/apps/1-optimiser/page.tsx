        ...
        subhead={
          <div className="space-y-6">
            ...
            <div className="bg-secondary/30 p-6 border-l-2 border-primary mt-6">
              ...
              <p className="text-sm">Large image files can contribute to heavier page payloads, while generic filenames and missing alt text provide less context for accessibility and discovery. 1-OPTIMISER helps merchants optimize image files and improve image metadata across their Shopify catalog, with tools designed to support storefront performance and image context. <Link href="/resources/ecommerce-image-optimization" className="text-primary hover:text-foreground transition-colors underline underline-offset-4 decoration-primary/30">Read our complete guide to image optimization</Link> and explore our <Link href="/resources/ecommerce-performance" className="text-primary hover:text-foreground transition-colors underline underline-offset-4 decoration-primary/30">ecommerce performance framework</Link>.</p>
            </div>
          </div>
        }
