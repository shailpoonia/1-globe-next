      ...
      <main className="flex-1">
        ...
        <Section className="py-24 md:py-32 border-b border-border bg-secondary/30">
          <div className="max-w-content mx-auto px-6 sm:px-8 lg:px-12 text-center">
            <span className="text-sm font-semibold uppercase tracking-widest text-muted-foreground block mb-6">About</span>
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-heading font-bold tracking-tight text-foreground leading-[1.05] uppercase mb-8">
              Built by a merchant,<br />
              not a <span className="text-primary italic">code factory</span>.
            </h1>
            <p className="text-xl md:text-2xl font-medium text-muted-foreground leading-relaxed max-w-3xl mx-auto">
        ...
        <Section className="py-24 md:py-32 bg-background border-b border-border">
          <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 space-y-8 text-lg text-muted-foreground leading-relaxed">
            <p>
